...
vim.api.nvim_create_user_command("W", "write", { desc = "Write" })
vim.api.nvim_create_user_command("Q", "quit", { desc = "Quit" })
vim.keymap.set("n", "<leader>dn", ":vnew<CR>:set filetype=markdown<CR>", { desc = "Open a new [n]otes buffer" })
